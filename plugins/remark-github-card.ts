...
<a class="card-github fetch-waiting" href="https://github.com/${repo}" target="_blank" rel="noopener noreferrer" data-repo="${repo}">
  ...
  <div class="gc-infobar">
    <div class="gc-stars">${STAR_ICON_SVG}<span>0</span></div>
    <div class="gc-forks">${FORK_ICON_SVG}<span>0</span></div>
    <div class="gc-license">${LICENSE_ICON_SVG}<span>-</span></div>
  </div>
</a>
`,
        },
