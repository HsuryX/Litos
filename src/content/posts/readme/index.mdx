...
| transition     | Whether to enable Astro View Transitions between pages.                                                                                                                                                              |
| themeAnimation | Whether to play the View Transitions animation when toggling light/dark mode.                                                                                                                                        |
